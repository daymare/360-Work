...
char* commandNames[] = {"ls", "cd", "pwd", "unlink", "link", "mkdir", "rmdir", "touch", "open", "close", "pfd", "lseek", "simlink","write", 0};

int (*commandPointers[])(Command*) = {(int (*)()) ls, cd, pwd, unlink, link, mkDir, rmdir, creat_file, myOpen, myClose, pfd, myLseek, simlink, write_file};
